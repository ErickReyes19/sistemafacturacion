...
export const columns: ColumnDef<Producto>[] = [
...

  {
    ...
    cell: ({ row }) => {
      ...
      const precioCompra = Number(row.getValue("precio_compra"));
      return (
        <div className="text-right">
          {precioCompra.toLocaleString("es-ES", {
            style: "currency",
            currency: "HNL",
          })}
        </div>
...

  {
    ...
    cell: ({ row }) => {
      const precioVenta = Number(row.getValue("precio_venta"));
      return (
        <div className="text-right">
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <Link href={`/producto/${producto.id}/detalle`}>
              <DropdownMenuItem>Ver Producto</DropdownMenuItem>
            </Link>
            <Link href={`/producto/${producto.id}/presentaciones`}>
              <DropdownMenuItem>Ver Presentaciones</DropdownMenuItem>
            </Link>
          </DropdownMenuContent>
        </DropdownMenu>
      );
